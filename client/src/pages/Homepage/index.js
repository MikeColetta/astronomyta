  ...
  return (
    <div className='pageStyle'>
      ...
      <Row>
        ...
        <br></br>
        <br></br>
        Each topic page will have videos and photos to show real life examples of each topic. Like the videos and images that you recommend so they will be seen by other teachers to help spread education about astronomy!
        <br></br>
        <br></br>
